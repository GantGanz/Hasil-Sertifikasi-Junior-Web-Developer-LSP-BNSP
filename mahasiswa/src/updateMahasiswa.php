...
<body>
  ...
  if (isset($_POST["submit"])) {
    if (update($_POST) > 0) { ?>
      <div class="alert alert-success" role="alert">
        Data berhasil diupdate. <a href="mahasiswa.php" class="alert-link">Klik disini untuk melihat tabel</a>.
    ...
    <?php
      ...
      <div class="alert alert-warning" role="alert">
        Data gagal diupdate. <a href="mahasiswa.php" class="alert-link">Klik disini untuk melihat tabel</a>.
        <a href="" onClick="window.location.href=window.location.href">(Klik disini untuk refresh)</a>
  ...
  <div class="container formcontainer border border-dark mt-4">
    <h2 class="alert alert-primary text-center mt-3 font-weight-bold">Form Update Data Mahasiswa</h2>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input id="NIM" type="number" name="nim" class="form-control" placeholder="Masukkan NIM" required autocomplete="off" value="<?= $mahasiswa["nim"]; ?>">
          </div>
        </div>
        <div class=" col-md-6">
          <div class="form-group">
            <label for="Nama">Nama : </label>
            <input id="Nama" type="text" name="nama" class="form-control" placeholder="Masukkan Nama Lengkap" required autocomplete="off" value="<?= $mahasiswa["nama"]; ?>">
          </div>
        </div>
      </div>
      <div class=" row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input id="Alamat" type="text" name="alamat" class="form-control" placeholder="Masukkan Alamat Lengkap" required autocomplete="off" value="<?= $mahasiswa["alamat"]; ?>">
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for="TanggalLahir">Tanggal Lahir : </label>
            <input id="TanggalLahir" type="date" name="tanggal_lahir" class="form-control" placeholder="dd-mmm-yyyy" required autocomplete="off" value="<?= $mahasiswa["tanggal_lahir"]; ?>">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <?php ?>
            <input type="radio" name="gender" value="Laki-laki" <?= ($mahasiswa["gender"] == "Laki-Laki") ? 'checked' : '' ?> required> Laki-laki<br>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input id="Agama" type="text" name="agama" class="form-control" placeholder="Masukkan Agama" required autocomplete="off" value="<?= $mahasiswa["agama"]; ?>">
          </div>
        </div>
      </div>
      <div class="row">
